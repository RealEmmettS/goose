...
- `docs/adr/` — architecture decision records. Read these when a task touches platform
  ...
  0028 records the shared goose control-surface icon and future tray behavior parity contract;
  ADR 0029 records the Alienware-derived Windows lifecycle, update, Corporate retry, and
  integrated-terminal hardening contract.
