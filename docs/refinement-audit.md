...
- The actual Windows and GNU Linux accessibility checks exposed a 64-widget truncation after a page gained changed-state labels, hiding Save from assistive readers. Both toolkit and bridge now retain up to 128 widgets. The isolated native Windows save and saved-status readback passed after correction; hosted OS-pattern checks are rerunning.
