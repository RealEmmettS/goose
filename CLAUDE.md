...
- `docs/adr/` — architecture decision records. Read these when a task touches platform
  ...
  identity and post-release hardware-verification boundary; ADR 0026 records the strict hosted
  Windows ARM64 compositor-evidence boundary without claiming a DWM screenshot.
