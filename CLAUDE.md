...
readiness is gated on CI host evidence rather than Windows-host claims. The Cargo workspace exists: `honk-engine` (platform-free
...
local gate, CI smoke gates, and pending host evidence log.
