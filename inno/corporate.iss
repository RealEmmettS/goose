...
Source: "{#SourceBinDir}\honk_settings_accessibility.dll"; DestDir: "{app}\channels\exe-corporate\releases\{#MyAppVersion}-{#TargetTriple}\bin"; DestName: "honk_settings_accessibility.dll"; Flags: ignoreversion uninsneveruninstall
