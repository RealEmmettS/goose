...
## Status
Done. Immutable v1.7.0, unchanged-source qualification, all eight fresh-public
installation lanes and the independent 47-asset audit pass. Website PR 10 is
deployed and verified with all 22 downloads and matching manifest payload hashes.
See docs/readiness/v1.7.0-readiness.md for the exact source and publication evidence.

## Activity
- 2026-09-08 — Close the Sway handoff after website PR 10, production deployment 6330307374, cross-platform website checks and actual served guidance/download/manifest verification. Preserve the user-restored r6 website artwork and keep later adapters unadvertised.
