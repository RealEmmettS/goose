TT;DR: Continuous goose rig and expressions.
...
Full silhouette, anatomy, face, continuous turning and gait redesign; bounded expressive task beats; real motion inspection and renderer export.
...
Active: full projected redraw, continuous rig, bounded expressions, real preview exports, and engine geometry/alpha/bounds plus configuration/TUI checks implemented. Native desktop, complete motion scenarios, compositor oracle migration, and release qualification remain open.
