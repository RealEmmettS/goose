...
### Fixed
- Extend the isolated stopping diagnostic to repeated real native deliveries with timed settling captures; no product motion or public qualification gate changes.
